...
lx_addative = partial(l_x_algo, K=750, conditions=[is_real, in_bounds],is_pgf=True,perturbation_type='additive')
...
plt.imshow(condition_nums_addative,
...
# plt.tight_layout()
# plt.show()
plt.savefig("/Users/mcboudre/Documents/LSD_Lab/stochastic-polys/figures/additive_conds_correctdist_r0_1-4_alpha_005-09_greens_60res_"+date+".pdf", format = "pdf")



# Saving all files

with open('/Users/mcboudre/Documents/LSD_Lab/stochastic-polys/data/additive_condition_nums_60res_'+date+'.npy', 'wb') as f:
